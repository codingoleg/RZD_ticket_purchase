...
Обязательные параметры РЖД:
    ...
    Плацкарт:
        ...
        Опциональные:
            ...
            included_plaz: набор номеров поездов, которые включены в поиск.
    ...
    Купе:
        ...
        Опциональные:
            excluded_coupe: набор номеров поездов, которые исключены из поиска.
            included_coupe: набор номеров поездов, которые включены в поиск.
